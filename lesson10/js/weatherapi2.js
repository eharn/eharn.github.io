const apiURL = "http://api.openweathermap.org/data/2.5/weather?q=Preston,5604473&units=imperial&appid=e5da55b917c0943f98ce55dedb68b5e8";
fetch(apiURL)
  ...
  const forcast = "http://api.openweathermap.org/data/2.5/forecast?q=Preston,5604473&units=imperial&appid=8b6ec3fb6e417dc46bee5c8dcafdab72";
  fetch(forcast)
  .then((response) => response.json())
  .then((jsObject) => {
  console.log(jsObject);
